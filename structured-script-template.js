(function () {
    ...
    Scatterplot.prototype = {
        setup: function () {
            ...
            chart.width = +chart.svg.attr("width") - margin.left - margin.right,
    		chart.height = +chart.svg.attr("height") - margin.top - margin.bottom;
            ...
            chart.x = d3.scaleLinear()
				.domain(d3.extent(messages,(d)=>d.timestamp))
				.range([0,chart.width]);
